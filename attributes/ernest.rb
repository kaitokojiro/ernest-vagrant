...
default['ernest']['connectors_list'] = 'nat.create.aws,nat.update.aws,nat.delete.aws,network.create.aws,network.delete.aws,route53.create.aws,route53.delete.aws,route53.update.aws,s3.create.aws,s3.update.aws,s3.delete.aws,elb.create.aws,elb.delete.aws,elb.update.aws,vpc.create.aws,vpc.delete.aws,instance.delete.aws,instance.update.aws,instance.create.aws,firewall.create.aws,firewall.update.aws,firewall.delete.aws,ebs.create.aws,ebs.update.aws,ebs.delete.aws,nat.find.aws,network.find.aws,route53.find.aws,s3.find.aws,elb.find.aws,vpc.find.aws,instance.find.aws,firewall.find.aws,ebs_volume.find.aws,rds_cluster.find.aws,rds_instance.find.aws'
